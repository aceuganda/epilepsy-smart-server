...
from .user import (UserView, UserDetailView, UserLoginView, ResetPassword, ClinicianView, ForgotPasswordView)
...
from .journal import (JournalsView, JournalsDetailView)
